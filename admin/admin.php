...
<body>
    ...
    <nav class="sidenav">
        <ul>
            ...
            <li class="pagebtn"><img src="../image/icon/event.png">&nbsp&nbsp&nbsp Hall Booking</li>            
            <li class="pagebtn"><img src="../image/icon/hall.png">&nbsp&nbsp&nbsp Halls</li>
            <li class="pagebtn"><img src="../image/icon/staff.png">&nbsp&nbsp&nbsp Staff</li>
            <li class="pagebtn"><img src="../image/icon/contact.png">&nbsp&nbsp&nbsp User Message</li>
        </ul>
    </nav>
    ...
    <div class="mainscreen">
        ...
        <iframe class="frames frame2" src="./hallbook.php" frameborder="0"></iframe>
        <iframe class="frames frame4" src="./hall.php" frameborder="0"></iframe>
        <iframe class="frames frame4" src="./staff.php" frameborder="0"></iframe>
        <iframe class="frames frame4" src="./User Messages.php" frameborder="0"></iframe>
    </div>
</body>
